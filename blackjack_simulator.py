...
def main():
    ...
    parser.add_argument('--hands', help='Number of hands to play', default=100000)
    ...
    with open(args.output_path, 'w', newline='') as csv_file:  # Add newline=''
    ...
    while hands_played < int(args.hands):
        ...
        while not table.shuffle_pending:
            ...
            with open(args.output_path, 'a', newline='') as csv_file:  # Add newline=''
                csv_writer = csv.DictWriter(csv_file, fieldnames=csv_columns)
